...
class QuestionsAndAnswers extends React.Component {
  ...
  incrementHandler = () => {
    ...
    if (
      (this.props.selected == "Multi-select" && this.id == 4) ||
      (this.props.selected == "Single select" && this.id == 2)
    ) {
  ...
  onInputChange = (e) => {
    ...
    this.setState({
      answers: { ...this.state.answers, [key]: e.target.value }
    });
  };
    ...
    return (
      <div>
        <form onSubmit={this.submitQuestion}>
          ...
          <span style={{ margin: "20px 20px" }}>Options</span>
          <div>
                  ...
                  <div className="input-group-append">
                    <span
                      ...
                      className={`input-group-text ${
                        this.state.addNpublish ? "disable" : ""
                      }`}
                    >
                      +
                    </span>
          ...
          <div
            className={this.state.addNpublish ? "" : "hide"}
            // style={{ float: "right" }}
          >
            <button
              type="submit"
